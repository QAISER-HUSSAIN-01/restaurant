  ...
  const formFields = (
    <Row gutter={[20, 0]}>
      <Col xs={24} md={12} xl={8}>
        <InputText label={"Issuance Number"} name={"Name"} />
      </Col>
      <Col xs={24} md={12} xl={8}>
      ...
      <Col xs={24} md={12} xl={8}>
        <InputSelect label={"From Department"} name={"Name"} />
      </Col>
      <Col xs={24} md={12} xl={8}>
        <InputSelect label={"To Department"} name={"Name"} />
      </Col>
      <Col xs={24} md={12} xl={8}>
        <InputText label={"Date"} name={"Name"} />
      </Col>
      <Col xs={24} md={12} xl={8}>
        <InputSelect label={"Item"} name={"ShortName"} />
      </Col>
      <Col xs={24} md={12} xl={8}>
